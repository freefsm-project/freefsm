...
func (_q *CustomerQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *CustomerQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *CustomerQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *CustomerQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *CustomerQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *CustomerQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(customer.FieldCompanyID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Customer.Query().
//		Select(customer.FieldCompanyID).
//		Scan(ctx, &v)
...
func (_q *CustomerQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(customer.Table, customer.Columns, sqlgraph.NewFieldSpec(customer.FieldID, field.TypeInt64))
	_spec.From = _q.sql
