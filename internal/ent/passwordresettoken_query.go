...
func (_q *PasswordResetTokenQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *PasswordResetTokenQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *PasswordResetTokenQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *PasswordResetTokenQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *PasswordResetTokenQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *PasswordResetTokenQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PasswordResetTokenQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(passwordresettoken.Table, passwordresettoken.Columns, sqlgraph.NewFieldSpec(passwordresettoken.FieldID, field.TypeInt64))
	_spec.From = _q.sql
