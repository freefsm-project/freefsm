...
func (_c *CommentCreate) SetObjectID(v int64) *CommentCreate {
	_c.mutation.SetObjectID(v)
	return _c
}

// SetAuthorID sets the "author_id" field.
func (_c *CommentCreate) SetAuthorID(v int64) *CommentCreate {
...
func (_c *CommentCreate) check() error {
	...
	if _, ok := _c.mutation.ObjectID(); !ok {
		return &ValidationError{Name: "object_id", err: errors.New(`ent: missing required field "Comment.object_id"`)}
	}
