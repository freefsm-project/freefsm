...
func (_q *ActivityLogQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ActivityLogQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *ActivityLogQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ActivityLogQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *ActivityLogQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *ActivityLogQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(activitylog.FieldCompanyID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.ActivityLog.Query().
//		Select(activitylog.FieldCompanyID).
//		Scan(ctx, &v)
...
func (_q *ActivityLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(activitylog.Table, activitylog.Columns, sqlgraph.NewFieldSpec(activitylog.FieldID, field.TypeInt64))
	_spec.From = _q.sql
