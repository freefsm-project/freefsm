...
func New(db *pgxpool.Pool, entClient *ent.Client, sessions *services.SessionService, cfg *config.Config) http.Handler {
	...
	r.Group(func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.With(requireActiveObject(entClient, "customer")).Post("/customers/{id}/contacts/inline", customerHandler.CreateContactInline)
			...
			r.With(requireActiveObject(entClient, "customer")).Post("/customers/{id}/locations/inline", customerHandler.CreateLocationInline)
